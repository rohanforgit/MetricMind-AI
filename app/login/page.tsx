  ...
  return (
    <div className="w-full max-w-md animate-fade-in z-10">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400 mt-2 text-sm">Sign in to your MetricMind AI account to continue</p>
      </div>
      ...
      <div className="glass-dark border border-slate-800 rounded-3xl p-8 shadow-2xl backdrop-blur-md">
        ...
        {message && (
          <div className="mb-6 flex items-start gap-3 bg-indigo-500/15 border border-indigo-500/30 rounded-xl p-3 text-indigo-300 text-xs">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <Link
                href="/login?message=Password reset link sent (mock)."
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center bg-slate-950/40 hover:bg-slate-900 border border-slate-850 hover:border-slate-700 text-slate-200 text-xs font-semibold py-2.5 px-4 rounded-xl transition-all active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
            type="button"
          >
    ...
    <div className="relative min-h-screen flex items-center justify-center bg-[#060a13] px-4 py-12 overflow-hidden text-slate-100 font-sans">
      ...
      <Suspense fallback={
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-slate-400 font-semibold tracking-wide">Loading form context...</p>
        </div>
      }>
        <LoginForm />
      </Suspense>
